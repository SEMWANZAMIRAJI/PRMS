      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="studentAllPerm" class="nav-link ">
                      <i class="far fa-circle nav-icon"></i>
                      <p>All Permissions</p>
          ...
          <li class="nav-item">
            <a href="studentAddPerm" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">{{$student->lastname}} Dashboard</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="row">
              <div class="col-lg-3 col-4">
                ...
                <div class="small-box bg-info">
                  <div class="inner">
                    <h3>{{$permissions->where('student_id',$student->id)->count()}}</h3>
                    {{-- @foreach ($students as $item)
                        <p>{{$item->course->cname}}</p>
                    @endforeach --}}
                    <p>All Permission</p>
                  </div>
                  <div class="icon">
                  ...
                  <a href="ViewallPermission" class="small-box-footer">All Permission <i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-4">
                ...
                <div class="small-box bg-success">
                  <div class="inner">
                    <h3>{{$student->permission->where('status','replied')->count()}}</h3>
                    {{-- @foreach ($students as $item)
                        <p>{{$item->course->cname}}</p>
                    @endforeach --}}
                    <p>Replied Permission</p>
                  </div>
                  <div class="icon">
                    <i class="ion ion-bag"></i>
                  </div>
                  <a href="viewrepliedperm" class="small-box-footer">Replied Permission <i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
                ...
                <div class="small-box bg-danger">
                  <div class="inner">
                    ...
                    {{-- @foreach ($students as $item)
                        <p>{{$item->course->cname}}</p>
                    @endforeach --}}
                    <p>Unreplied Permission</p>
                  </div>
                  <div class="icon">
                    <i class="ion ion-bag"></i>
                  </div>
                  <a href="unrepliedpermis" class="small-box-footer">Unreplied Permission <i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
