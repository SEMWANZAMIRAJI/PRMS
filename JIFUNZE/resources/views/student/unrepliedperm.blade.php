      ...
      <nav class="mt-2">
        ...
        <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="unrepliedpermis" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                      @php
                        $id = 0;
                      @endphp
                      @if ($student->permission->where('status','unreplied')->count() > 0)
                  ...
                  <div class="text-count pt-3 pb-5">
                      <div class="float-right fw-bold" style="color: #a5a4a4;">
                        All Permissions: {{ $student->permission->where('status','unreplied')->count() }}
                      </div>
                  </div>
                </div>
            </div>
